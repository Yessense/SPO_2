...
@contextmanager
def redirected(out: io._io._TextIOBase = sys.stdout, err: io._io._TextIOBase = sys.stderr) -> tp.Iterator[None]:
    """
...
def execute(code: types.CodeType,
            ...
            *args: tp.Any) -> tp.Tuple[str, str, tp.Optional[tp.Type[BaseException]]]:
    """
